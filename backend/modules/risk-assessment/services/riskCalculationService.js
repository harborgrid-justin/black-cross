...
class RiskCalculationService {
   ...
   * @returns {number} Risk score
   */
  calculateWithModel(riskData, model) {
   ...
   */
  getLikelihoodScore(likelihood, model) {
   ...
   */
  determineRiskLevel(score, model) {
