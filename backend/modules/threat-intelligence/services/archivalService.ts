...
class ArchivalService {
   ...
   */
  async archiveThreats(criteria: any) {
    try {
   ...
   */
  async getHistoricalThreats(filters: Record<string, any> = {}) {
    try {
   ...
   */
  async restoreThreats(threatIds: any) {
    try {
   ...
   */
  async deleteArchivedThreats(criteria: any) {
    try {
   ...
   */
  async applyRetentionPolicy(policy: any) {
    try {
