...
class CategorizationService {
   ...
   */
  async categorizeThreat(threatId: any, categories: any) {
    try {
   ...
   */
  async autoCategorizeThreat(threatId: any) {
    try {
   ...
   * @returns {Promise<Object>} Updated threat
   */
  async addTags(threatId: any, tags: any) {
    try {
   ...
   * @returns {Promise<Object>} Updated threat
   */
  async removeTags(threatId: any, tags: any) {
    try {
   ...
   */
  async searchByCategoriesOrTags(filters: Record<string, any>) {
    try {
      const query: any = {};
