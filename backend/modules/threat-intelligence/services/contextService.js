...
class ContextService {
   ...
   */
  async getThreatContext(threatId) {
    try {
   ...
   */
  async reconstructAttackChain(threat) {
    try {
      const chain = {
        kill_chain_phases: [],
   ...
   */
  analyzeIndustryTargeting(threat) {
   ...
   */
  analyzeGeographicDistribution(threat) {
    const distribution = {
      countries: [],
      regions: [],
      source: 'geolocation'
   ...
   */
  async analyzeTemporalPatterns(threat) {
    try {
      const analysis = {
        first_seen: threat.first_seen,
        last_seen: threat.last_seen,
   ...
   */
  async getRelatedThreatsContext(threatId) {
    try {
   ...
   */
  async analyzePatterns(threatIds) {
    try {
